...
ensures Sorted(arr, 0, arr.Length)
{
    ...
    if(arr.Length >= 1){
        ...
        invariant multiset(arr[..]) == multiset(old(arr[..]))
        {
            ...
            // everything below what we have sifted down is sorted by definition of shuffling
            // we also want to say everything that is above the sifted down index is bigger
            invariant forall i, j :: 0 <= i < j < up && i != siftedDownIndex ==> arr[i] < arr[j]
            ...
            // here is where we restore our multiset invariant
            // we will uncorrupt our array, and put the rogue value in it's correctly ordered position
