// just method headtail for submission
// i commented out the code below which has all the other code for class
// note the commented code below did not modify the class provided in Ex3.dfy
...
// comment above method and uncomment this to see it works :D
